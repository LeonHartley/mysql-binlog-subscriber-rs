...
pub fn test_handshake_decode() {
    let msg: Vec<u8> = vec! { 10, 53, 46, 53, 46, 53, 45, 49, 48, 46, 51, 46, 49, 50, 45, 77, 97, 114, 105, 97, 68, 66, 45, 108, 111, 103, 0, 42, 0, 0, 0, 108, 93, 108, 41, 38, 126, 109, 39, 0, 254, 247, 33, 2, 0, 191, 129, 21, 0, 0, 0, 0, 0, 0, 7, 0,
